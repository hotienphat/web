...
const phepMauLyrics = [
    ...
    { time: 114, text: "Hah-hah-ah-ah-ah-ah" },
    ...
    { time: 150, text: "Thiếu em tôi sợ bơ vơ" },
    { time: 157, text: "Vắng em như tàn cơn mơ" },
    { time: 167, text: "Chẳng phải phép màu vậy sao chúng ta gặp nhau?" },
    { time: 170, text: "Một người khẽ cười, người kia cũng dịu nỗi đau" },
    { time: 178, text: "Gọi tôi thức giấc cơn ngủ mê, dìu tôi đi lúc quên lối về" },
    { time: 191, text: "Quãng đời thanh xuân sao em cho tôi giữ lấy, giữ lấy" },
    { time: 127, text: "(Qua bao khổ đau, ta bên cạnh nhau)" },
    { time: 224, text: "Chẳng phải phép màu vậy sao chúng ta gặp nhau?" },
    { time: 231, text: "Một người khẽ cười, người kia cũng dịu nỗi đau" },
    { time: 237, text: "Gọi tôi thức giấc cơn ngủ mê, dìu tôi đi lúc quên lối về" },
    { time: 244, text: "Quãng đời mai sau luôn cạnh nhau" },
    { time: 251, text: "Quãng đời mai sau luôn cạnh nhau" },
    { time: 255, text: "HẾT" },
];
